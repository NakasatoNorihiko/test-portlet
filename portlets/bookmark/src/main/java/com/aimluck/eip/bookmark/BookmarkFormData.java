 ...
 *
 */
public class BookmarkFormData extends ALAbstractFormData {

  /** logger */
  private static final JetspeedLogger logger = JetspeedLogFactoryService
    .getLogger(BookmarkFormData.class.getName());
...
//    }
  ...
  protected boolean loadFormData(RunData rundata, Context context,
    ...
    try {
      // オブジェクトモデルを取得
      EipTTest test = BookmarkUtils.getEipTTest(rundata, context, false);
      if (test == null) {
        return false;
      }
      // タイトル
...
//        .longValue());
      // 開始日
//      if (BookmarkUtils.isEmptyDate(test.getStartDate())) {
...
//      }
      // 締切日
//      if (BookmarkUtils.isEmptyDate(test.getEndDate())) {
...
//      addon_schedule_flg.setValue(test.getAddonScheduleFlg());
  ...
  protected boolean deleteFormData(RunData rundata, Context context,
    ...
    try {
      ...
      Database.rollback();
      logger.error("[BookmarkFormData]", t);
      return false;
    }
    return true;
  }
...
//      } else {
//        category =
//          BookmarkUtils.getEipTTestCategory(Long.valueOf(category_id.getValue()));
//      }
...
//      } else {
//        test.setStartDate(BookmarkUtils.getEmptyDate());
//      }
      // 締切日
//      if (end_date_check.getValue() == null) {
//        test.setEndDate(end_date.getValue().getDate());
//      } else {
//        test.setEndDate(BookmarkUtils.getEmptyDate());
//      }
      // 状態
...
//      }
      ...
      BookmarkUtils.createTestActivity(
        test,
        loginName,
        recipients,
        true,
...
//              message.setPcBody(BookmarkUtils.createMsgForPcTmpl(
//                rundata,
//                test,
//                memberList,
//                true));
//              message.setCellularBody(BookmarkUtils.createMsgForPcTmpl(
//                rundata,
//                test,
//                memberList,
//                true));
