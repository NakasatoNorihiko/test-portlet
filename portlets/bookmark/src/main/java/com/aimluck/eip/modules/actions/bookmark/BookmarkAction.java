...
import com.aimluck.eip.test.BookmarkFormData;
import com.aimluck.eip.test.BookmarkMultiDelete;
import com.aimluck.eip.test.BookmarkSelectData;
 ...
 *
 */
public class BookmarkAction extends ALBaseAction {

  /** logger */
  private static final JetspeedLogger logger = JetspeedLogFactoryService
    .getLogger(BookmarkAction.class.getName());

  static final String LIST_FILTER_STR = new StringBuffer()
    .append(BookmarkSelectData.class.getName())
  ...
  static final String LIST_SORT_STR = new StringBuffer().append(
    BookmarkSelectData.class.getName()).append(ALEipConstants.LIST_SORT).toString();
  ...
  protected void buildNormalContext(VelocityPortlet portlet, Context context,
    ...
    BookmarkSelectData listData = new BookmarkSelectData();
    listData.initField();
...
//    }
     ...
     */
    /*
     * BookmarkSelectData listData = new BookmarkSelectData(); listData.initField();
...
//        doTest_category_detail(rundata, context);
  ...
  public void doTest_form(RunData rundata, Context context) throws Exception {
    BookmarkFormData formData = new BookmarkFormData();
    formData.initField();
...
//    formData.loadCategoryList(rundata);
  ...
  public void doTest_multi_delete(RunData rundata, Context context)
      throws Exception {
    BookmarkMultiDelete delete = new BookmarkMultiDelete();
...
//    listData.loadCategoryList(rundata);
  ...
  public void doTest_detail(RunData rundata, Context context) throws Exception {
    BookmarkSelectData detailData = new BookmarkSelectData();
...
//  }
  ...
  private void clearTestSession(RunData rundata, Context context) {
    ...
    list.add("com.aimluck.eip.test.BookmarkSelectDatafilter");
    list.add("com.aimluck.eip.test.BookmarkSelectDatafiltertype");
